<template>
    <ul>
        <li class="posts-block overflow-hidden shadow-lg " v-for="(post, i) in this.$props.posts" :key="i">
            <!-- <Avatar/> -->
            ...
            <form v-on:submit.prevent="submit(post.id)">
                <!-- increments the like -->
                <button type="submit" @click="liked += 1">
