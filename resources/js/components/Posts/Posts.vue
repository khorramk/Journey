<template>
    <div>
        <li class="max-w-sm rounded overflow-hidden shadow-lg bg-light-grey border border-8 border-black" v-for="(post, i) in this.$props.posts" :key="i">
            <Avatar/>
            <div class="px-6 py-4">
                <div class="font-bold text-xl mb-2" v-if="users-posts">
                    {{post.posts}}
                </div>
